...
public class Rules {
  ...
  private static Option email = new Option("--email",
      "Generate email messages. If this option is provided, then --email-template must also be provided.");
  private static Option emailTemplate = new Option("--email-template", false, true, txtPattern,
      "A filename for the email template");
  private static Option letter = new Option("--letter",
      "Generate letters. If this option is provided, then --letter-template must also be provided.");
  private static Option letterTemplate = new Option("--letter-template", false, true, txtPattern,
      "A filename for the letter template.");
  private static Option input = new Option("--csv-file", true, true, csvPattern,
      "The CSV file to process. This option is required.");
  private static Option output = new Option("--output-dir", true, true,
